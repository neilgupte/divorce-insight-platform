  ...
  return (
    <div className="flex flex-col h-screen p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        {/* ← New right‐aligned controls */}
        <div className="flex space-x-2">
          <Button variant="outline" size="sm" onClick={() => window.location.assign("/network/dashboard")}>
            <MapPin className="mr-1 h-4 w-4"/>Map View
          </Button>
          <Button variant="outline" size="sm" onClick={() => window.location.assign("/network/table")}>
            <TableIcon className="mr-1 h-4 w-4"/>Table View
          </Button>
          <Button variant="outline" size="sm" onClick={() => setFullscreenMapOpen(true)}>
            <Maximize className="mr-1 h-4 w-4"/>Expand Map
          </Button>
        </div>
      </div>
          ...
          <Card className="h-full overflow-hidden">
            <CardHeader>
              <div className="flex justify-between items-center">
                ...
                {/* we keep your little icon buttons here too */}
