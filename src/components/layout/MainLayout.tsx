...
const MainLayout = () => {
  ...
  let activeModule = "real-estate-iq";
  if (location.pathname.startsWith("/labour-potential")) activeModule = "labour-potential";
  else if (location.pathname.startsWith("/labour-planning")) activeModule = "labour-planning";
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      >
        <div className="flex h-full flex-col">
          {/* Top section with model switcher or toggle */}
          ...
          {/* Dynamically render the correct navigation menu */}
          <MainNavigationMenu
            module={activeModule}
